    ...
    public class DbInitializer
    {
        ...
        context.Database.EnsureCreated();
           ...
           if (context.Device.Any())
            ...
            new Device {Manufacture = "Apple", Name = "Iphone 11", Memory = 128, RamMemory = 6, ScreenSize = 6.4F, Price = 1499},
          ...
          new Accessorie{Manufacture="Xiaomi", Name="Charger", Price=40,SupplierID=1},
           ...
           context.SaveChanges();
            ...
            var branch = new Branches[]
            {
                ...
                new Branches{ Name="RH" , Address ="34 Derech Yavne St. Rehovot" ,Latitude = 31.904788 ,Longitude =34.808276 },
